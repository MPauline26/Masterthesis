...
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=mi_pct_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=cnt_units_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=orig_upb_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=flag_fthb_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=flag_mi_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=flag_cnt_units_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
