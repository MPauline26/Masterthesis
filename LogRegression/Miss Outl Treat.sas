...
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=fico_ADJ, GROUP=GROUP2, N_BAR=10, TYPE_VAR=NUM);

%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=cltv_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=cltv_ADJ, GROUP=GROUP2, N_BAR=10, TYPE_VAR=NUM);

%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=dti_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=dti_ADJ, GROUP=GROUP2, N_BAR=10, TYPE_VAR=NUM);

%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=ltv_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=ltv_ADJ, GROUP=GROUP2, N_BAR=10, TYPE_VAR=NUM);

%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=cnt_borr_ADJ, GROUP=GROUP1, N_BAR=10, TYPE_VAR=NUM);
%UNIV_ANALYSIS(DATA=&USED_DATASET._FINAL, VAR=cnt_borr_ADJ, GROUP=GROUP2, N_BAR=10, TYPE_VAR=NUM);
