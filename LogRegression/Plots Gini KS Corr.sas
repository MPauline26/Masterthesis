...
%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_mi, GROUP=GROUP2, N_BAR=10, TYPE_VAR=IND);

%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_orig_loan_term_HI_360M, GROUP=GROUP1, N_BAR=10, TYPE_VAR=IND);
%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_orig_loan_term_HI_360M, GROUP=GROUP2, N_BAR=10, TYPE_VAR=IND);

%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_orig_loan_term_HEQ_360M, GROUP=GROUP1, N_BAR=10, TYPE_VAR=IND);
%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_orig_loan_term_HEQ_360M, GROUP=GROUP2, N_BAR=10, TYPE_VAR=IND);

%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_orig_loan_term_EQ_360M, GROUP=GROUP1, N_BAR=10, TYPE_VAR=IND);
%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=flag_orig_loan_term_EQ_360M, GROUP=GROUP2, N_BAR=10, TYPE_VAR=IND);

%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=orig_loan_term_3grp, GROUP=GROUP1, N_BAR=10, TYPE_VAR=CAT);
%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=orig_loan_term_3grp, GROUP=GROUP2, N_BAR=10, TYPE_VAR=CAT);

%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=cd_ppty_val_type, GROUP=GROUP1, N_BAR=10, TYPE_VAR=CAT);
%UNIV_ANALYSIS(DATA=&USED_DATASET., VAR=cd_ppty_val_type, GROUP=GROUP2, N_BAR=10, TYPE_VAR=CAT);
